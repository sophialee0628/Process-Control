...
X0=[144;339;320;339];
tspan=0:0.02:200;
Kc_TC=-0.0000001; Ti_TC=0.001; Td_TC=(1/4)*Ti_TC;
Kc_FC=0.35; Ti_FC=0.3; Td_FC=(1/4)*Ti_FC;
...
for i=1:length(tspan)-1
    ...
    if i==1
         ep=0; e=0;  ypp=0; yp=0; y=0;
    elseif i==2
         ep=e; e=r-X(end,4); ypp=0; yp=y; y=-X(end,4); 
    else
         ep=e; e=r-X(end,4); ypp=yp; yp=y; y=-X(end,4); 
    end  
    dwc_sp=Kc_TC*(e-ep + (1/Ti_TC)*e + Td_TC*(y-2*yp+ypp));
    wc_sp=wc_sp+dwc_sp;
    if wc_sp<0
        wc_sp=0;
    end
